...
\begin{align*}
    \Delta \cdot \vec{E} &= \rho\\
    \Delta \times \vec{E} &= -\frac{\partial \vec{B}}{\partial t}\\
    \Delta \vec{B} &= 0\\
    \Delta \times \vec{B} &= \mu_0 \vec{J} + \mu_0 \epsilon_0 \frac{\partial \vec{E}}{\partial t}
\end{align*}
...
\begin{align*}
    \Delta^2\vec{E} = \frac{1}{c^2}\left(\frac{\partial^2 \vec{E}}{\partial^2t}\right)&&
    \Delta^2\vec{B} = \frac{1}{c^2}\left(\frac{\partial^2 \vec{B}}{\partial^2t}\right)
\end{align*}
