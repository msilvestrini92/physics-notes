...
As you can already guess, the $F$ and $B$ matrices are one the inverse of the other: $B = F^{-1}$, and to simply prove it, we can easily re-arrange and subsitute the above \ref{eq5} and \ref{eq6}:
